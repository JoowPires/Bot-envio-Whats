def bot():
    ...
    contatos_df = pd.read_excel('assets/Contatos.xlsx')
    ...
    def sendMessage(pessoa, numero, mensagem):
        ...
        try:
            (wd.find_element(
                By.XPATH, '//*[@id="main"]/footer/div[1]/div/span[2]/div/div[2]/div[2]').size != 0)
            time.sleep(5)
            print('Numero encontrado')
            sendBtn = wd.find_element(
                By.XPATH, '//*[@id="main"]/footer/div[1]/div/span[2]/div/div[2]/div[2]')
            sendBtn.click()
